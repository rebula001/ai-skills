---
name: submodule-sync
description: Use when the user says “请同步子模块” and wants to commit changed submodule files, push them back to the submodule's upstream repository, then update the parent project's submodule pointer.
---
