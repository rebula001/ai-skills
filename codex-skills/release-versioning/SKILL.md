...
description: Use when the user wants to prepare a release version, decide the next release number under Semantic Versioning, explain why the version should be major, minor, or patch, confirm whether to create a dedicated release commit, and update version-related files before committing.
---
